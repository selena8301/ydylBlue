  ...
  <div class="zhuanti-edit-detail">
    ...
    <div class="content-box">
      ...
      <div class="choose-box">
        <span>国家</span>
        <el-select v-model="detailData.country" size="mini" filterable placeholder="请选择" @change="setFl(item)">
          <el-option
        ...
        <span>分类</span>
        <el-select
          v-model="detailData.topicName"  size="mini"
          filterable
          placeholder="请选择"
          @change="setFl(item)"
        >
    ...
    <div class="bottom-line">
      ...
      <div class="bottom-btn">
        <span class="usual-btn" @click="lastArticle" v-show="showLastArticle"
          >上一篇</span
        >
        <span class="usual-btn" @click="nextArticle">下一篇</span>
...
export default {
  ...
  computed: {
    ...
    showLastArticle() {
      return this.$parent.currentIndex > 0;
    },
  },
  mounted() {
